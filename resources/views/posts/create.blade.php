...
<div class="md:flex md:items-center">
    ...
    <div class="md:w-1/2 bg-white p-10 rounded-lg shadow-xl mt-10 md:mt-0">
        <form action="{{route('posts.store')}}" method="POST" novalidate>
            ...
            <input type="submit" value="Crear Publicación" class="bg-sky-600 hover:bg-sky-700 transition-colors uppercase  cursor-pointer rounded-lg text-white w-full p-3">
        </form>
    </div>
